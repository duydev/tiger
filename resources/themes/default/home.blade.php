...
<div class="container sitecontainer bgw">
                ...
                <div class="large-widget m30">
                    <div class="post clearfix">
                        <div class="post-media">
                            <a href="single.html">
                                <img alt="" src="{{ Theme::url( 'upload/big_news_01.jpg' ) }}" class="img-responsive">
                            </a>
                        </div>
                        ...
                        <div class="large-widget-title">
                            <a href="single.html"> How ThePhone thriller will change the way film directors manufacture fear</a>
                        </div>
                    ...
                    <div class="post clearfix">
                        <div class="post-media">
                            <a href="single.html">
                                <img alt="" src="{{ Theme::url( 'upload/big_news_02.jpg' ) }}" class="img-responsive">
                            </a>
                        </div>
                        <div class="large-post-meta">
                            <span class="avatar"><a href="author.html"><img src="{{ Theme::url( 'upload/avatar_01.png' ) }}" alt="" class="img-circle"> Kubra Karahasan</a></span>
                            <small>&#124;</small>
                            <span><a href="category.html">Tips & Tricks</a></span>
                            <small>&#124;</small>
                            <span><a href="single.html#comments">14 Comments</a></span>
                        </div><!-- end meta -->
                        <div class="large-widget-title">
                            <a href="single.html"> User details can reportedly be exposed on over 95% of HTTPS connections</a>
                        </div>
                        <div class="post-share">
                            <div class="customshare">
                                 <span class="list">
                                    <strong><i class="fa fa-share-alt"></i> 36
                                    <a href="#" class="tw"><i class="fa fa-twitter"></i></a>
                                    <a href="#" class="fb"><i class="fa fa-facebook"></i></a>
                                    <a href="#" class="gp"><i class="fa fa-google-plus"></i></a>
                                    </strong>
                    ...
                    <div class="post clearfix">
                        <div class="post-media">
                            <a href="single.html">
                                <img alt="" src="{{ Theme::url( 'upload/big_news_03.jpg' ) }}" class="img-responsive">
                            </a>
                        </div>
                        <div class="large-post-meta">
                            <span class="avatar"><a href="author.html"><img src="{{ Theme::url( 'upload/avatar_01.png' ) }}" alt="" class="img-circle"> Kubra Karahasan</a></span>
                            ...
                            <small>&#124;</small>
                            <span><a href="single.html#comments">41 Comments</a></span>
                        </div><!-- end meta -->
                        <div class="large-widget-title">
                            <a href="single.html"> Outstanding Office Design and Workspace Examples for Inspiration</a>
                        </div>
                        <div class="post-share">
                            <div class="customshare">
                                 <span class="list">
                                    <strong><i class="fa fa-share-alt"></i> 122
                                    <a href="#" class="tw"><i class="fa fa-twitter"></i></a>
                                    <a href="#" class="fb"><i class="fa fa-facebook"></i></a>
                                    <a href="#" class="gp"><i class="fa fa-google-plus"></i></a>
                                    </strong>
        ...
        <div class="col-md-12">
            <div class="widget">
                <div class="ads-widget">
                    <a href="#"><img src="{{ Theme::url( 'upload/banner_02.jpg' ) }}" alt="" class="img-responsive"></a>
                </div><!-- end ads-widget -->
            </div><!-- end widget -->
        </div><!-- end col -->
    </div><!-- end row -->
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="widget">
                <div class="widget-title">
                    <h4>Latest News <span><a href="#">View all</a></span></h4>
                    <hr>
                </div><!-- end widget-title -->
                ...
                <div class="review-posts row m30">
                    <div class="post-review col-md-3 col-sm-12 col-xs-12">
                        <div class="post-media entry">
                            <img src="{{ Theme::url( 'upload/news_01.jpg' ) }}" alt="" class="img-responsive">
                            <div class="magnifier">
                    ...
                    <div class="post-review col-md-3 col-sm-12 col-xs-12">
                        <div class="post-media entry">
                            <img src="{{ Theme::url( 'upload/news_02.jpg' ) }}" alt="" class="img-responsive">
                            <div class="magnifier">
                                <div class="hover-title-left">
                    ...
                    <div class="post-review col-md-3 col-sm-12 col-xs-12">
                        <div class="post-media entry">
                            <img src="{{ Theme::url( 'upload/news_03.jpg' ) }}" alt="" class="img-responsive">
                            <div class="magnifier">
                                <div class="hover-title-left">
                    ...
                    <div class="post-review col-md-3 col-sm-12 col-xs-12">
                        <div class="post-media entry">
                            <img src="{{ Theme::url( 'upload/news_04.jpg' ) }}" alt="" class="img-responsive">
                            <div class="magnifier">
                                <div class="hover-title-left">
                                    <span><a href="#" title=""><i class="fa fa-folder-open"></i> Space</a></span>
                                </div><!-- end title -->
                ...
                <div class="review-posts row m30">
                    <div class="post-review col-md-3 col-sm-12 col-xs-12">
                        <div class="post-media entry">
                            <img src="{{ Theme::url( 'upload/news_05.jpg' ) }}" alt="" class="img-responsive">
                            <div class="magnifier">
                                <div class="hover-title-left">
                                    <span><a href="#" title=""><i class="fa fa-folder-open"></i> Mobile</a></span>
                                </div><!-- end title -->
                    ...
                    <div class="post-review col-md-3 col-sm-12 col-xs-12">
                        <div class="post-media entry">
                            <img src="{{ Theme::url( 'upload/news_06.jpg' ) }}" alt="" class="img-responsive">
                            <div class="magnifier">
                                <div class="hover-title-left">
                                    <span><a href="#" title=""><i class="fa fa-folder-open"></i> Automotive</a></span>
                                </div><!-- end title -->
                    ...
                    <div class="post-review col-md-3 col-sm-12 col-xs-12">
                        <div class="post-media entry">
                            <img src="{{ Theme::url( 'upload/news_07.jpg' ) }}" alt="" class="img-responsive">
                            <div class="magnifier">
                                <div class="hover-title-left">
                                    <span><a href="#" title=""><i class="fa fa-folder-open"></i> Space</a></span>
                                </div><!-- end title -->
                    ...
                    <div class="post-review col-md-3 col-sm-12 col-xs-12">
                        <div class="post-media entry">
                            <img src="{{ Theme::url( 'upload/news_08.jpg' ) }}" alt="" class="img-responsive">
                            <div class="magnifier">
                                <div class="hover-title-left">
                                    <span><a href="#" title=""><i class="fa fa-folder-open"></i> Space</a></span>
                                </div><!-- end title -->
